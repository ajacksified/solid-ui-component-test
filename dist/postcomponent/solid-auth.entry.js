...
class LoginButton {
    constructor() {
        this.login = async () => {
            await AuthService$1.login(this.popup);
        };
    }
    render() {
