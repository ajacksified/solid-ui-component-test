...
class PostComponent {
    ...
    static get style() { return ".profile-image.sc-post-create{width:50px}.new-post.sc-post-create{max-width:200px;position:absolute;margin-left:10px}.new-post.sc-post-create   h2.sc-post-create{color:#555;margin-bottom:6px}.new-post-form-input.sc-post-create{width:200px;height:50px;border-radius:8px;margin-top:10px;border-color:#ccc}.post-list.sc-post-create{margin:10px;color:#555;font-family:sans-serif}.post-list.sc-post-create   h3.sc-post-create{text-decoration:underline;text-transform:uppercase;font-size:18px}.post-list-item.sc-post-create{width:400px;height:100px;overflow:auto;border:1px solid #ccc;padding:4px;margin-bottom:12px}.post-list-item-name.sc-post-create{font-size:16px;margin:8px 4px}.post-list-item-image.sc-post-create{float:left;margin-right:14px;margin-left:10px}.post-list-item-text.sc-post-create{font-size:12px;color:#333}.post-button.sc-post-create{background-color:#7c4dff;color:#fff;padding:6px 24px;cursor:pointer;border-radius:14px;margin-top:4px}"; }
}
